...
class CameraViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, URLSessionDelegate, URLSessionTaskDelegate {
    ...
    @IBAction func TakePictureViewController(_ sender: UIButton) {
    ...
    @IBAction func uploadActionButton(_ sender: UIButton) {
        ...
        if imageView.image != nil {
            ...
            let alertController = UIAlertController(title: "Error: No Image!", message: "You did not select an image! Please click on 'Camera' or 'Library' to select a photo for analysis.", preferredStyle: .alert)
            let defaultAction = UIAlertAction(title: "Okay.", style: .default, handler: nil)
            alertController.addAction(defaultAction)
            present(alertController, animated: true, completion: nil)
        }
